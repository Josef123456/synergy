 ...
 *
 */
package synergy.nachocalendar.holidays;
...
import synergy.nachocalendar.components.DayRenderer;
...
public class HolidayDecorator implements DayRenderer {
    ...
    /**
     * @see synergy.nachocalendar.components.DayRenderer#getDayRenderer(DayPanel, java.util.Date,
     * Object, boolean, boolean, boolean)
     */
    public Component getDayRenderer(DayPanel daypanel, Date day, Object data, boolean selected,
                                    boolean working, boolean enabled) {
        Component retorno = renderer.getDayRenderer(daypanel, day, data, selected, working,
                enabled);
