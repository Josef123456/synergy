 ...
 * 
 */
package synergy.nachocalendar.model;
...
import synergy.nachocalendar.components.CalendarUtils;
import synergy.nachocalendar.event.DateSelectionEvent;
import synergy.nachocalendar.event.DateSelectionListener;
...
public class DefaultDateSelectionModel implements DateSelectionModel {
    ...
    /**
     * @see synergy.nachocalendar.model.DateSelectionModel#addSelectionInterval(java.util.Date,
     *      java.util.Date)
     */
    ...
    /**
     * @see synergy.nachocalendar.model.DateSelectionModel#clearSelection()
     */
    ...
    /**
     * @see synergy.nachocalendar.model.DateSelectionModel#isSelectedDate(java.util.Date)
     */
    ...
    /**
     * @see synergy.nachocalendar.model.DateSelectionModel#isSelectionEmpty()
     */
    ...
    /**
     * @see synergy.nachocalendar.model.DateSelectionModel#removeSelectionInterval(java.util.Date,
     *      java.util.Date)
     */
    ...
    private void fireDateSelectionListenerValueChanged(
        ...
        for (int i = listeners.length - 2; i >= 0; i -= 2) {
            if (listeners[i] == DateSelectionListener.class) {
                ((DateSelectionListener) listeners[i + 1])
                        .valueChanged(event);
            }
        }
    }
     ...
     *
     * 
     * @see synergy.nachocalendar.model.DateSelectionModel#getLeadSelectionDate()
     */
     ...
     *
     * 
     * @see synergy.nachocalendar.model.DateSelectionModel#setLeadSelectionDate(java.util.Date)
     */
     ...
     *
     * 
     * @see synergy.nachocalendar.model.DateSelectionModel#getSelectedDate()
     */
     ...
     *
     * 
     * @see synergy.nachocalendar.model.DateSelectionModel#setSelectedDate(Object)
     */
    ...
    /**
     * @see synergy.nachocalendar.model.DateSelectionModel#setSelectedDates(Object[])
     */
