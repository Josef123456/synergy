 ...
 *
 * Created on August 21, 2004, 1:46 AM
 */
 ...
 */
public class PlainCalendarDemo extends javax.swing.JDialog {
    DateField d1, d2;
    /** Creates new form PlainCalendarDemo */
    public PlainCalendarDemo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        d1 = CalendarFactory.createDateField();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel3.setText("(one click required)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabel4.setText("(ok/cancel buttons provided)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jPanel2.add(bCalc, new java.awt.GridBagConstraints());

        tResult.setColumns(15);
        tResult.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        gridBagConstraints.weightx = 1.0;
        jPanel2.add(tResult, gridBagConstraints);
    ...
    private void bCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcActionPerformed
        Date c1 = (Date) d1.getValue();
        Date c2 = (Date) d2.getValue();
        if ((c1 != null) && (c2 != null)) {
            long t = c2.getTime() - c1.getTime();
            if (t < 0) t *= -1;
            int d = (int)(t / (3600000 * 24));
            tResult.setText("Time Difference: " + d + " days");
        } else tResult.setText("");
